...
# Модель обучена на ручной разметке владельца — 543 фотографии по той самой
# лесенке тиров, что видит пользователь. Проверка на отложенных данных
# (10-кратная кросс-валидация): корреляция 0.76, тир угадан в 38% случаев
...
MODEL_MEAN = [4.244153, 0.310288, 0.968906, 0.721272, 1.484294, 0.794272, 138.658565, 0.399528, 0.30128, 0.833246, 0.880181, 0.794272, 0.192668, 0.319337, 0.455983, 0.399528, 0.135028, -0.120875, 0.702846, 0.224559, 0.640975, 0.04178, 2.218893, 0.631505, 0.775219, 19251.226835, 26.421728, 0.696274, 0.160581, 0.091194]
MODEL_SCALE = [2.899809, 0.047066, 0.025763, 0.120404, 0.12556, 0.025252, 5.002912, 0.030955, 0.020588, 0.04444, 0.022378, 0.025252, 0.010076, 0.033925, 0.023488, 0.030955, 0.009523, 0.044285, 0.039849, 0.121764, 0.075523, 0.020624, 0.375218, 0.040025, 0.039405, 1373.681864, 23.732531, 0.074609, 0.024828, 0.012493]
MODEL_COEF = [0.276666, -0.242954, 0.161025, 0.337918, 1.57037, 0.768799, -0.680213, 0.587074, 2.279986, 0.821958, 0.127749, 0.768799, 0.002788, -0.069891, 8.5e-05, 0.587074, -0.111913, -1.792985, -0.278716, 2.4484, 0.181319, -0.09538, -0.552366, 1.072339, -2.19386, 0.836963, 0.050356, -1.377031, -0.650706, -2.505111]
MODEL_INTERCEPT = 4.591529
...
# уровень.
RAW_POINTS = [-0.1149, 1.9666, 2.4906, 2.8181, 3.1263, 3.3221, 3.5255, 3.7223, 4.0236, 4.3145, 4.5553, 4.8188, 5.0812, 5.3039, 5.6055, 5.8124, 6.0558, 6.421, 6.7682, 7.3548, 9.4279]
TARGET_POINTS = [0.8, 1.3, 1.9, 1.93, 2.64, 3.0, 3.2, 3.2, 3.68, 4.0, 4.3, 4.6, 5.32, 5.9, 6.2, 6.6, 6.9, 6.9, 7.3, 8.0, 10.0]
