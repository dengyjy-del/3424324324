...
# Модель обучена на ручной разметке владельца — 106 фотографий, размеченных
# по той самой лесенке тиров, что показывается пользователю. Проверка
# leave-one-out: корреляция 0.73 против 0.66 у прежней версии, обученной на
# подобранных из интернета примерах.
#
...
MODEL_MEAN = [3.905878, 0.300455, 0.965851, 0.698442, 1.505058, 0.80014, 137.799524, 0.405236, 0.301003, 0.839778, 0.885955, 0.80014, 0.193855, 0.323784, 0.451751, 0.405236, 0.134143, -0.125609, 0.701039, 0.208962, 0.630999, 0.043698]
MODEL_SCALE = [2.985886, 0.049739, 0.028451, 0.125163, 0.135979, 0.026167, 5.435416, 0.032229, 0.024314, 0.04822, 0.024622, 0.026167, 0.010949, 0.036617, 0.024121, 0.032229, 0.010528, 0.04669, 0.046634, 0.128026, 0.078848, 0.021716]
MODEL_COEF = [0.35748, -0.115679, 0.226479, 0.694175, 0.986409, 0.495589, -0.057087, 0.129721, -0.13628, -0.352812, -1.067036, 0.495589, 0.567493, 0.747801, -0.237725, 0.129721, -0.124594, 0.593592, 0.615106, 0.586347, -0.20526, -0.706276]
MODEL_INTERCEPT = 4.198113
MODEL_PIVOT = 4.1981
